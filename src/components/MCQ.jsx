...
export default function MCQ() {
    return (
            <div className="flex flex-col h-[100%] items-center gap-4 justify-center">
              <div className="w-2/4 rounded-lg border border-solid border-black bg-[#ecf9ff] text-center shadow-2xl ">
                ...
                <div className="flex flex-wrap justify-between text-lg ml-4 mr-2 mb-4">
                  <McqChoice/>
                  <McqChoice/>
                  {/* <McqChoice/>
                  <McqChoice/> */}
                ...
                <div>
                <button className="w-24 h-12 border border-solid border-black  bg-[#ecf9ff] mr-4 text-xl">Clear</button>
                <button className="w-24 h-12 border border-solid border-black  bg-[#ecf9ff] text-xl">Next</button>
                </div>
            </div>
    )
}
