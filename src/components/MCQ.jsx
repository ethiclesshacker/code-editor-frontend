...
export default function MCQ() {
    return (
            <div className="flex h-[100%] items-center gap-4 justify-center">
              <div className="h-4/5 w-2/4 rounded-lg border border-solid border-black bg-[#ecf9ff] text-center shadow-2xl ">
                ...
                <div className="flex flex-wrap justify-between text-xl">
                  <div className="flex border border-solid border-black w-160 pl-4 items-center rounded-lg ml-8 mt-8">
                  ...
                  <div className="flex border border-solid border-black w-160 pl-4 rounded-lg items-center mr-8 mt-8">
                    <input type="radio" id="html" name="fav_language" value="HTML" className="mr-1.5 w-8 h-4"/>
                    <label for="html">Ea ex velit sint officia commodo Lorem aliquip adipisicing pariatur tempor irure irure.</label>
                  </div>
                  <div className="flex border border-solid border-black w-160 pl-4 rounded-lg items-center ml-8 mt-8">
                    <input type="radio" id="html" name="fav_language" value="HTML" className="mr-1.5 w-8 h-4"/>
